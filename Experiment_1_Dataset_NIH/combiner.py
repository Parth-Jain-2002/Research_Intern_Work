...
class MAPOracleCombiner():
    ...
    def fit(self, model_probs, y_h, y_true, num_humans = NUM_HUMANS):
    ...
    def combine_proba(self, model_probs, y_h, humans = list(range(NUM_HUMANS))):
    ...
    def combine(self, model_probs, y_h, humans = list(range(NUM_HUMANS))):
